    ...
    <article className="overflow-x-hidden">
      <header className="border-b border-[var(--line)] bg-[var(--panel)]">
        <div className="mx-auto max-w-4xl min-w-0 px-4 py-10 sm:px-6 lg:px-8">
          ...
          <h1 className="mt-3 max-w-full break-words text-4xl font-semibold leading-tight [overflow-wrap:anywhere] sm:text-5xl">
            {post.title}
          </h1>
          <p className="mt-5 max-w-3xl break-words text-lg leading-8 text-[var(--muted)] [overflow-wrap:anywhere]">{post.excerpt}</p>
      ...
      <div className="mx-auto max-w-5xl min-w-0 px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-3xl break-words whitespace-pre-line py-10 text-base leading-8 text-[var(--foreground)] [overflow-wrap:anywhere] sm:text-lg">
          {post.content}
        </div>
      </div>
    </article>
